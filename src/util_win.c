...
/*   Updated: 2022/01/20 00:18:17 by dramos-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_conf_img(t_mlx	*mlx)
{
	...
	img = ft_lstnew_md(ft_strdup("img/x_p.xpm"), '1');
	mlx->conf_img = ft_lstnew_md(ft_strdup("img/floor.xpm"), '0');
	ft_lstadd_back_md(&mlx->conf_img, img);
	img = ft_lstnew_md(ft_strdup("img/fruit.xpm"), 'C');
	ft_lstadd_back_md(&mlx->conf_img, img);
	img = ft_lstnew_md(ft_strdup("img/out.xpm"), 'E');
	ft_lstadd_back_md(&mlx->conf_img, img);
	img = ft_lstnew_md(ft_strdup("img/h_r.xpm"), 'P');
	ft_lstadd_back_md(&mlx->conf_img, img);
}
